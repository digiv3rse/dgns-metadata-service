...
const OPDGNSEA_API_KEY = process.env.OPDGNSEA_API_KEY || '6f51f596970944488fc6efcfc8d8e136';
...
const ADDRESS_DIGI_REGISTRY = process.env.ADDRESS_DIGI_REGISTRY || '0x2B998843f58b5450C1C9c9f23c50c37B94603409'
