...
export async function dgnsMetadata(req: Request, res: Response) {
  ...
  try {
    ...
    try {
      // Here is the case; if subgraph did not index fresh DGNS name but registry has the record,
      ...
      assert(isRecordExist, 'DGNS name does not exist');
