...
const doc = {
  ...
  definitions: {
    AvatarMetadata: {
      $uri: 'DGNS name of avatar holder',
    ...
    DGNSMetadata: {
      $name: 'DGNS name',
      $description: 'Short DGNS name description',
      $attributes: 'Custom traits about DGNS',
      $name_length: 'Character length of dgns name',
      $url: 'DGNS App URL of the name',
      $version: 'DGNS NFT version',
