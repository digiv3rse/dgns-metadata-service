            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (nftOwner === config_1.ADDRESS_NAME_WRAPPER) {
                        return [2 /*return*/, { tokenId: _tokenId, version: base_1.Version.v1 }];
                    }
                ...
                case 4:
                    error_1 = _a.sent();
                    console.warn("error for ".concat(contract.address), error_1);
                    return [3 /*break*/, 5];
...
function checkV2Contract(contract, identifier) {
    return __awaiter(this, void 0, void 0, function () {
        var isInterfaceSupported, error_2, namehash, isWrapped;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(contract.address !== config_1.ADDRESS_NAME_WRAPPER)) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    error_2 = _a.sent();
                    throw new base_1.ContractMismatchError("".concat(contract.address, " does not match with any DGNS related contract"), 400);
                case 4:
                    namehash = (0, namehash_1.getNamehash)(identifier);
                    return [4 /*yield*/, contract.isWrapped(namehash)];
                case 5:
                    isWrapped = _a.sent();
                    (0, assert_1.strict)(isWrapped);
...
function checkContract(provider, contractAddress, identifier) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            _contractAddress = ethers_1.ethers.utils.getAddress(contractAddress);
            contract = new ethers_1.ethers.Contract(_contractAddress, [
                'function ownerOf(uint256 id) view returns (address)',
                'function supportsInterface(bytes4 interfaceId) external view returns (bool)',
                'function isWrapped(bytes32 node) public view returns (bool)',
            ], provider);
            if (_contractAddress === config_1.ADDRESS_DIGI_REGISTRAR) {
