...
function avatarImage(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, networkName, provider, _b, buffer, mimeType, error_1, errCode;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    // #swagger.description = 'DGNS avatar image'
                    // #swagger.parameters['networkName'] = { schema: { $ref: '#/definitions/networkName' } }
                    // #swagger.parameters['name'] = { description: 'DGNS name', schema: { $ref: '#/definitions/ensName' } }
