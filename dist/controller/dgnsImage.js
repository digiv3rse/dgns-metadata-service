...
function dgnsImage(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, contractAddress, networkName, identifier, _b, provider, SUBGRAPH_URL, _c, tokenId, version, result, base64, buffer, error_1, errCode;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    // #swagger.description = 'DGNS NFT image'
