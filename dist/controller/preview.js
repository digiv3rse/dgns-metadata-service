...
function preview(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            // #swagger.description = 'DGNS NFT preview'
            // #swagger.parameters['name'] = { type: 'string', description: 'DGNS name.' }
            res.setTimeout(config_1.RESPONSE_TIMEOUT, function () {
                res.status(504).json({ message: 'Timeout' });
            });
            name = req.params.name;
            try {
                if (!name || name.length < 7 || !name.endsWith('.digi')) {
                    throw Error("".concat(name, " is not an DGNS name."));
                }
