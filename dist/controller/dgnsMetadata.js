...
function dgnsMetadata(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, contractAddress, networkName, identifier, _b, provider, SUBGRAPH_URL, last_request_date, tokenId, version, result, error_1, errCode, registry, _namehash, isRecordExist, _c, url, unknownMetadata, error_2;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    // #swagger.description = 'DGNS NFT metadata'
                    ...
                    // #swagger.parameters['tokenId'] = { type: 'string', description: 'Labelhash(v1) /Namehash(v2) of your DGNS name.\n\nMore: https://docs.dgns.domains/contract-api-reference/name-processing#hashing-names', schema: { $ref: '#/definitions/tokenId' } }
                ...
                case 3:
                    ...
                    /* #swagger.responses[200] = {
                      ...
                      schema: { $ref: '#/definitions/DGNSMetadata' }
                    } */
                    res.json(result);
                    return [2 /*return*/];
                case 4:
                    ...
                    if (error_1 instanceof node_fetch_1.FetchError ||
                        error_1 instanceof base_1.ContractMismatchError ||
                ...
                case 5:
                    _e.trys.push([5, 7, , 8]);
                    registry = new ethers_1.Contract(config_1.ADDRESS_DIGI_REGISTRY, config_1.DIGI_REGISTRY_ABI, provider);
                    if (!tokenId || !version) {
                ...
                case 6:
                    ...
                    (0, assert_1.strict)(isRecordExist, 'DGNS name does not exist');
                    _c = new metadata_1.Metadata({
                        name: 'unknown.name',
                        description: 'Unknown DGNS name',
...
exports.dgnsMetadata = dgnsMetadata;
